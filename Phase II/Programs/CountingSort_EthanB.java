...
File Name: CountingSort_EthanB.java
Description:
Uses a counting sort algorithm to sort through an array of elements. The size of this array can be adjusted when necessary.
...
public class CountingSort_EthanB
{
    public static void main(String[] args)
    {
       int arraySize = 100000; //Adjust the size as needed
       ...
       arr = countingSort(arr); //Commence counting sort
    ...
    public static int[] countingSort(int arr[])
    {
        ...
        for (int i = 0; i < n; i++)
        {
            max = Math.max(max, arr[i]); //Max value is largest value in array
        }//end for
 
        int[] countArray = new int[max + 1]; //Create counting array
        ...
        int[] outputArray = new int[n]; //Create output array
        ...
        return outputArray; //Return sorted array
    }//end countingSort
